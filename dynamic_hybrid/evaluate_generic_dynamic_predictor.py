...
def main():
    ...
    parser.add_argument('--normalization', type=str, default=None,
                        choices=['l2', 'min_max'],
                        help='Override normalization technique (default: use from model)')
    parser.add_argument('--combination', type=str, default=None,
                        choices=['arithmetic_mean', 'geometric_mean', 'harmonic_mean'],
                        help='Override combination technique (default: use from model)')
    ...
    # Load dataset configuration from model or use overrides
