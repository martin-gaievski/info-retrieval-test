...
# Example script to evaluate dynamic hybrid search on FiQA dataset
# This demonstrates how to use the POC with financial Q&A dataset
...
DATASET="fiqa"
DATASET_URL="https://public.ukp.informatik.tu-darmstadt.de/thakur/BEIR/datasets/fiqa.zip"
HOST="${HOST:-localhost}"
PORT="${PORT:-9200}"
...
echo "=== Configuration ==="
echo "Dataset: ${DATASET} (Financial Question Answering)"
echo "Host: ${HOST}:${PORT}"
...
echo "=== Dynamic Hybrid Search Evaluation for FiQA ==="
echo ""
...
COMPARE_CMD="python dynamic_hybrid/evaluate_dynamic_hybrid_standalone.py \
    ...
    --compare \
    --static-weights \"0.5,0.5\" \"0.6,0.4\" \"0.7,0.3\" \"0.4,0.6\" \"0.3,0.7\" \"0.1,0.9\" \"0.9,0.1\" \"0.8,0.2\" \"0.2,0.8\""
