#!/usr/bin/env python3
"""
Extract CQADupStack Android relevance judgments with ultra-aggressive sanitization for OpenSearch.
...
def create_opensearch_judgments_format(qrels: Dict, all_queries: Dict) -> Dict:
    ...
    opensearch_judgments = {
        "name": "CQADupStack Android Relevance Judgments",
        "description": f"CQADupStack Android containing relevance judgments for {len(judgment_ratings)} Stack Exchange queries from the BEIR benchmark dataset",
...
def main():
    """Main function to extract and format CQADupStack Android judgments."""
    
    # File paths
    queries_file = "datasets/cqadupstack/android/queries.jsonl"
    qrels_file = "datasets/cqadupstack/android/qrels/test.tsv"
    output_file = "results/cqadupstack_android_judgments.json"
    
    print("=" * 80)
    print("CQADupStack Android Judgment Extraction with ULTRA-AGGRESSIVE Sanitization")
    print("=" * 80)
